...
import com.yourname.warehouse.criteria.*;
import java.util.*;
...
public class ApplianceServiceImpl implements ApplianceService {
    ...
    public List<Laptop> findLaptops() throws ServiceException {
        try {
            // Using the DaoFactory to get the specific DAO
    ...
    public Appliance<?> findCheapest() throws ServiceException {
        try {
            ...
            // Business logic to find the minimum price
    ...
    public List<Appliance<?>> findByPrice(Range<Long> range) throws ServiceException {
        try {
            ...
            // Note: We use the range.contains logic inside the SearchCriteria
            ...
            // Wrapping DAL exceptions into ServiceExceptions
